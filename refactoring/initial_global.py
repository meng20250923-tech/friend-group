...
if __name__ == "__main__":
    # Create the group dictionary here (no longer global)
    group = {
        "Jill": {
            "age": 26,
            "job": "biologist",
    ...
    # Now pass 'group' as the first argument to functions that modify it
    add_person(group, "Nash", 34, "chef", nash_relations)

    forget(group, "Nash", "John")

    # Update assertions to pass 'group' as argument
